...
public class JobController {
    ...
    @PostMapping(value = "/getListJobOfCompanyManage")
    public List<Job> getListJobOfCompanyManage(@RequestBody String body) {
        return jobService.findJobByIdCompanyManage(body);
    }
